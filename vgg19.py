...
# ============================================
# Step 7: Convert Tabular → Image (FIXED)
# ============================================
num_features = X_scaled.shape[1]

target_size = 32 * 32  # ✅ FIX (must be >= features)
...
# Step 14: Save
# ============================================
model.save('vgg19_potato_model.h5')
...
# Load Model
# ============================
model = load_model('vgg19_potato_model.h5', compile=False)
model.compile(optimizer='adam', loss='mse', metrics=['mae'])
