...
# Step 14: Save
# ============================================
model.save('mobilenet_potato_model.h5')
...
# Load Model
# ============================
model = load_model('mobilenet_potato_model.h5', compile=False)
model.compile(optimizer='adam', loss='mse', metrics=['mae'])
...
# ============================
# Step 6: Convert to MobileNet Input
# ============================
