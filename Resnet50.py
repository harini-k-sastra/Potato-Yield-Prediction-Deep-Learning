...
# ResNet needs larger input
X_image = tf.image.resize(X_image, (224, 224)).numpy()
...
# Step 14: Save
# ============================================
model.save('resnet50_potato_model.h5')
...
# Load Model
# ============================
model = load_model('resnet50_potato_model.h5', compile=False)
model.compile(optimizer='adam', loss='mse', metrics=['mae'])
...
# ============================
# Step 6: Convert to ResNet50 Input
# ============================
...
sample_image = tf.image.resize(sample_image, (224, 224)).numpy()
